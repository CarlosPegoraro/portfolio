  ...
  const projects = [
    {
      ...
      technologies: ["Laravel", "PostgreSQL", "React", "TypeScript", "Stripe API"],
    ...
    },
    {
      ...
      technologies: ["PHP", "PostgreSQL", "Redis", "Docker", "Swagger"],
    ...
    },
    {
      ...
      technologies: ["Laravel", "Vue.js", "WebSockets", "MySQL", "Pusher"],
    ...
    },
    {
      ...
      technologies: ["PHP", "Chart.js", "PostgreSQL", "React", "D3.js"],
            ...
            >
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex space-x-2">
                  <button className="text-portfolio-mint hover:text-portfolio-cyan transition-colors">
